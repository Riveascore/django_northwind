...
class Customers(models.Model):
    customerid = models.CharField(primary_key=True, max_length=-1)
...
class Region(models.Model):
    ...
    regiondescription = models.CharField(max_length=-1)
...
class Territories(models.Model):
    ...
    territorydescription = models.CharField(max_length=-1)
